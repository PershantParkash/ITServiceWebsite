...
import { TrendingUp, Security, Cloud } from "@mui/icons-material";
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={8}>
            <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
              ...
              >
                Empowering your business with expert IT Support, Azure Cloud Solutions, 
                and Strategic Consulting. Reliable, scalable, and client-focused digital transformation.
              </Typography>
